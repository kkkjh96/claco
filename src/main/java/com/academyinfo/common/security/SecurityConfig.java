    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
            ...
            .and() // 로그인 설정
	            ...
	            .defaultSuccessUrl("/")	// 로그인이 성공했을 시 나올 결과창
	            .permitAll()
            ...
            .and() // POST 사용 시 security 무시해야 하는 영역
    			...
    			.ignoringAntMatchers("/academy/post")
    			.ignoringAntMatchers("/claco/post")
    			.ignoringAntMatchers("/review/post")
    			.ignoringAntMatchers("/admin/edit")
    			.ignoringAntMatchers("/favorite/post")
    		    	 //
            .and() // 로그아웃 설정
	            .logout()
	            .logoutRequestMatcher(new AntPathRequestMatcher("/user/logout"))
	            .logoutSuccessUrl("/")	// 로그아웃 성공했을 시 나올 결과창
